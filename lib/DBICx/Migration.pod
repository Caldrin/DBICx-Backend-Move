...
PostgreSQL you use C<new DBICx::Migration::Psql>. Currently, Psql and SQLite
are supported. If you want it even more easy, there is an application that
uses DBICx::Migration. Have a look at L<App::DBICx::Migration>.
